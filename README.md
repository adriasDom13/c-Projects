...
Synthesis for RRL 
1. This case support the importance of tracking employee attendance and productivity using an automated process through RFID. The study is related to the research topic. 
2. Employee's productivity is the center of this case as it is relating to where people spend most of their time while working in the office. Capturing time arrived and time when an employee leave work is related to this project. The idea is the same to the project objective.
3. Innovation through technology can increase employee productivity and at the same time help the business track employee hours of effectively. This will strengthen the importance of having a utilization dashboard for better decision making as what this topic intend to solve.
4. The importance of tracking employee's activity remotely using employee utilization software mirror the idea of building a software intended to employee who's currently working from home. The study is related to my project topic.
...
6. Developing a software that is able to capture employee's activity also provide insight for the leadership to have further quality check on how work is being delivered to the customers. Data captured will be beneficial for performance audit which this study also talks about.
...
8. 
9.Investing to the best interest of employee can give more value to the organization. This case supports the importance of knowing how to better compensate and provide R&R program through employee productivity performance is necessary by leveraging employee performance records generated by the software proposed in this topic.
10. Looking at the employee utilization dashboard can help managers to promote work life balance to those that aren't utilizing the paid leaves and to employees with high utilization rate. Ensuring employee welfare and time for family is making a lot of sense. Data generated in the proposed software will help managers to make better decisions.
11. Optimizing employee capacity to do the job is vital for the quality of work being delivered. This case supports the main objective of employee utilization dashboard to allocate task effectively.
12. 
...
14. Employee's duty and responsibility are common factors that contributes to their performance. Having aa productivity management system will help managers delegate work base on the capacity of someone to perform the job. This case is related to the topic.
...
16. Employee's attachment and detachment from work should be taken seriously. The researcher's topic will help upper management to strategize and plan accordingly base on how employee perform through the information data a software can generate.
17. 
18. 
19.
20.
